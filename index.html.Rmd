...
```{r, eval=FALSE}
vector("BLANCO","ROSA","AZUL","AMARILLO","ROJO","NARANJA","NEGRO","MORADO","CAFE","VERDE","CELESTE","BEIGE","CARMIN","AQUA","FIUSHA")
```
...
```{r, eval=FALSE}
compClase <- c("KAO","AURORA","MELANNY","YEYE","MORE","CRIS", "NANI", "JOSE", "JHOS", "VALE")
print(logicos)
```
